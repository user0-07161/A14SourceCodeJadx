...
public class FileProvider extends ContentProvider {
    ...
    private SimplePathStrategy mStrategy;
    ...
    private static SimplePathStrategy getPathStrategy(Context context, String str) {
        ...
        synchronized (hashMap) {
            ...
            if (simplePathStrategy == null) {
                try {
                    try {
                        simplePathStrategy = parsePathStrategy(context, str);
    ...
    public static Uri getUriForFile(Context context, File file) {
        return getPathStrategy(context, "com.android.egg.fileprovider").getUriForFile(file);
    }

    private static SimplePathStrategy parsePathStrategy(Context context, String str) {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        if (!providerInfo.exported) {
            if (providerInfo.grantUriPermissions) {
                ...
                this.mStrategy = getPathStrategy(context, str);
                return;
            }
